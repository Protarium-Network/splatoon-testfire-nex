...
// LocalAuthMode enables a self-contained preservation deployment. It uses the
// local account registry instead of Pretendo's account and friends services.
// Keep it disabled for any shared deployment.
